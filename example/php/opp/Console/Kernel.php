...
use App\Console\Commands\CloseExpiredOpp;
use App\Console\Commands\BuildForecastOwnerArch;
use App\Console\Commands\BuildForecastDetailOwnerArch;
...
class Kernel extends ConsoleKernel
{
     ...
     */
    protected $commands = [
        CloseExpiredOpp::class,
        BuildForecastOwnerArch::class,
        BuildForecastDetailOwnerArch::class,
    ];
