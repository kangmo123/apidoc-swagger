...
/**
 * @apiDefine ListOpportunityParams
 * @apiParam {String} opportunity_id 根据 opportunity_id 筛选，非必填
 * @apiParam {String} opp_name 根据 opp_name 筛选，精确查询，非必填
 * @apiParam {String} keyword 根据 opp_name 筛选，模糊查询，非必填
...
/**
 * @apiDefine       ListOpportunityParamExample
 * @apiParamExample 查询商机参数示例
 * {
 *      "opp_name": "金城武",
 *      "page": 1,
 *      "per_page": 15,
...
class OpportunityFilter
{
    ...
    {
        $this->opportunityId = $request->get('opportunity_id');
        $this->oppName       = $request->get('opp_name');
